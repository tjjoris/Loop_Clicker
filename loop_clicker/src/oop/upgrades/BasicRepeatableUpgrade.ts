...
export default class BasicRepeatableUpgrade extends Upgrade {
    ...
    constructor(score: Score, upgradesData: 
        ...
        this.state = {name: upgradesData.name, description: upgradesData.description, cost: upgradesData.cost, iterationAmount: 0, count: 0, canAfford: false, isReveal: false};
